...
export class PolySceneWithNodeMap_scene_01 extends PolyScene {
  ...
  override node(path: "/geo1/exporterSTL1"): ExporterSTLSopNode;
...
export interface PolySceneProps_scene_01 {
  ...
  "geo1-exporterSTL1--fileName"?: ParamValueSerializedTypeMap["string"];
  "geo1-exporterSTL1--download"?: ParamValueSerializedTypeMap["button"];
